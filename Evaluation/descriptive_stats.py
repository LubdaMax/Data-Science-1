...
def get_hist(ws, cs, wa, ca, wbs, cbs):
    ...
    ax[1,0].boxplot([ws, wbs])
    ax[1,1].boxplot([cs, cbs])
    plt.show()
...
get_hist(wiki_summ_len, cnn_summ_len, wiki_art_len, cnn_art_len, wiki_bayes_summ_len, cnn_bayes_summ_len)
