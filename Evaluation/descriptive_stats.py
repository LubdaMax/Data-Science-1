...
cnn_min_sum, cnn_max_sum = cnn_summ_len.min(), cnn_summ_len.max()
wiki_min_sum, wiki_max_sum = wiki_summ_len.min(), wiki_summ_len.max()
cnn_min, cnn_max = cnn_art_len.min(), cnn_art_len.max()
wiki_min, wiki_max = wiki_art_len.min(), wiki_art_len.max()


get_hist(wiki_summ_len, cnn_summ_len, wiki_art_len, cnn_art_len)
print(cnn_min_sum, cnn_max_sum)
print(wiki_min_sum, wiki_max_sum)

print(cnn_min, cnn_max)
print(wiki_min, wiki_max)