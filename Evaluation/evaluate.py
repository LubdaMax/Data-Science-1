...
if method == "naivebayes":
    ...
    openfile = open(Path.joinpath(rootpath, r"LexRank\wiki_TRoutput_summ_dict_stemm_3sent_inclDigits"), 'rb')
    wiki_data = pickle.load(openfile)
    openfile.close()

    openfile = open(Path.joinpath(rootpath, r"LexRank\cnn_TRoutput_summ_dict_stemm_3sent_inclDigits"), 'rb')
...
if method == "naivebayes":
    ...
    print("cnn_ref: ", cnn_summ[100])
    print(len(cnn_summ))
    print("cnn_out: ",cnn_generated_summ[100])
    print(len(cnn_generated_summ))
    print("wiki_ref: ",wiki_summ[0])
    print("wiki_out", wiki_generated_summ)
